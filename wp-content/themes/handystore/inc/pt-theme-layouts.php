...
function pt_layout_metabox_contents($post) {
	...
	$post_layouts = pt_get_default_layouts();
  	...
  	$admin_page = get_template_directory_uri() . 'plumtree/plumtree.php';
  	?>
...
function pt_script_enqueue_post($hook) {
    if( 'post.php' != $hook )
        return;
    	wp_enqueue_style('plumtree-formstyler-css', get_template_directory_uri() . '/ptpanel/css/formstyler.css');
		wp_enqueue_script('plumtree-formstyler-js', get_template_directory_uri() . '/ptpanel/js/formstyler.min.js', array('jquery'));
}
