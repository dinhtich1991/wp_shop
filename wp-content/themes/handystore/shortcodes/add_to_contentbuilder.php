...
require_once('builder_shortcodes/woo_codes/woo_codes.php');
require_once('builder_shortcodes/vendors_carousel/vendors_carousel.php');
require_once('builder_shortcodes/salesCarousel/salescarousel.php');
require_once('builder_shortcodes/contact/contact.php');
require_once('builder_shortcodes/testimonials/testimonials.php');
require_once('builder_shortcodes/gmaps/gmaps.php');
