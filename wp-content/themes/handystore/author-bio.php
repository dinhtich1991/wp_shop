...
<div class="author-info">
	...
	<div class="author-description" >
		<h2 class="author-title" itemprop="author" itemscope="itemscope" itemtype="http://schema.org/Person">
			<?php printf( __( 'By <a class="author-link" rel="author" href="%s" itemprop="url"><span itemprop="name">%s</span></a>', 'plumtree' ), esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ), get_the_author() ); ?>
		</h2>
