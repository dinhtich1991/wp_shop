...
class pt_contacts_widget extends WP_Widget {
    ...
    */
    public function upload_scripts()
    {
    	...
    	wp_enqueue_script( 'upload_media_widget', get_template_directory_uri() .''.str_replace(str_replace('\\', '/', get_template_directory()), '',str_replace('\\', '/', __DIR__)).'/js/upload-media.js', array('jquery'), true);
	...
	?>
		...
		<p>
            ...
            <input class="pt_upload_image_button" type="button" value="<?php _e('Upload Image', 'plumtree'); ?>" />
        </p>
		<p>
