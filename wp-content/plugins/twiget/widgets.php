...
class Twiget_Twitter_Widget extends WP_Widget{
	...
	public function update( $new_instance, $old_instance ){	// This function processes and updates the settings
	...
	public function form( $instance ){		// This function sets up the settings form
